(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".gallery__slider")) new core(".gallery__slider", {
            ...
            loop: true,
            navigation: {
                prevEl: ".gallery__arrows .slider-arrow_prev",
                nextEl: ".gallery__arrows .slider-arrow_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1
...
*/
    ...
    window.onload = function() {
        ...
        function scrollUp() {
            ...
            img1.style.transform = "translateY(-0" + .05 * value + "px)";
            img2.style.transform = "translateY(0" + .05 * value + "px)";
        }
        ...
        text.reveal(`.main__subtitle`, {
            delay: 500
        });
        text.reveal(`.main__description`, {
            delay: 400
        });
        text.reveal(`.main__link`, {
            distance: "0",
            delay: 2300,
            opacity: 0
        });
        text.reveal(`.main__contacts`, {
            distance: "0",
            delay: 2400,
            opacity: 0,
            interval: 400
        ...
        about.reveal(`.about__sign, .about__subtitle`, {
            delay: 1500,
            opacity: 0,
            distance: "0"
        });
        about.reveal(`.about__images`, {
            delay: 1e3,
            opacity: 0,
            distance: "0"
        });
        about.reveal(`.about__title`, {
            delay: 700
        });
        about.reveal(`.about__text`, {
            delay: 500
        });
        about.reveal(`.about__text-grey`, {
            delay: 300
        });
        about.reveal(`.about__content`, {
            delay: 100
        });
        ...
        work.reveal(`.works__item`, {
            origin: "bottom",
            delay: 800
        });
        work.reveal(`.staff__link`, {
            origin: "right",
            delay: 800
        });
        work.reveal(`._before`, {
        ...
        opacity.reveal(`.item-testimonial__icon, .callback__img`, {
            delay: 800
        });
        opacity.reveal(`.item-testimonial__text`, {
            delay: 500
        });
        opacity.reveal(`.testimonials__item`, {
            delay: 200
        });
    };
    window["FLS"] = true;
